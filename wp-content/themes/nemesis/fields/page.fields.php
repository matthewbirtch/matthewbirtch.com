...
$theme_sidebar = array('(no sidebar selected)','Page Sidebar', 'Contact Sidebar', 'Blog Sidebar');
...
$page_postmetas = 
	array (
		...
		*/
		...
		array("section" => "Page Description", "id" => "page_desc", "type" => "text", "title" => "Page Description", "description" => "Enter short desciption of this page."),
		
		array("section" => "Page Sidebar", "id" => "page_sidebar", "type" => "select", "title" => "Page Sidebar", "description" => "Please select a sidebar to display on this page (if you select sidebar enabled page template)", "items" => $theme_sidebar),
